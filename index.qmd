...
<table>
    <!-- Ligne 1 -->
    <tr title="Date" style="background-color: rgb(180, 180, 180)">
        <th>    
            <strong>{nameday[0]} </strong>
            <br>Today
        </th>
        <th>
        ...
        <th>
            ...
            <br>{tabmonth[4]}
                ...
                <th>
            <strong> {nameday[5]} </strong>
            <br>{tabmonth[5]}
        </th>
        <th>
            <strong> {nameday[6]} </strong>
            <br>{tabmonth[6]}
        </th>
    </tr>
    <!-- Ligne Images svg -->
        <tr title="Date" style="background-color: rgb(255, 255, 255)">
        <th>
            <img src="{tabimg[0]}" width="100px" height="75px">
        </th>
        <th>
            <img src="{tabimg[1]}" width="100px" height="75px">
        </th>
        <th>
            <img src="{tabimg[2]}" width="100px" height="75px"> 
        </th>
        <th>
            <img src="{tabimg[3]}" width="100px" height="75px"> 
        </th>
        <th>
            <img src="{tabimg[4]}" width="100px" height="75px"> 
        </th>
        <th>
            <img src="{tabimg[5]}" width="100px" height="75px"> 
        </th>
        <th>
            <img src="{tabimg[6]}" width="100px" height="75px"> 
        </th>
        
    </tr>
    <!-- Ligne 2 -->
    <tr title="Temperatures min- max" style="background-color: rgb(255, 255, 255)">
        <th>
            Temperatures
    ...
    <!-- Ligne 4 -->
        <th>
            Precipitations
            <img src="docs/humidity.svg" width="20px" height="15px"> {data["daily"]["precipitation_sum"][0]} mm
        </th>
        <th>
            Precipitations
            <img src="docs/humidity.svg" width="20px" height="15px"> {data["daily"]["precipitation_sum"][1]} mm
        </th>
        <th>
            Precipitations
            <img src="docs/humidity.svg" width="20px" height="15px"> {data["daily"]["precipitation_sum"][2]} mm
        </th>
        <th>
            Precipitations
            <img src="docs/humidity.svg" width="20px" height="15px"> {data["daily"]["precipitation_sum"][3]} mm
        </th>
        <th>
            Precipitations
            <img src="docs/humidity.svg" width="20px" height="15px"> {data["daily"]["precipitation_sum"][4]} mm
        </th>
        <th>
            Precipitations
            <img src="docs/humidity.svg" width="20px" height="15px"> {data["daily"]["precipitation_sum"][5]} mm
        </th>
        <th>
            Precipitations
            <img src="docs/humidity.svg" width="20px" height="15px"> {data["daily"]["precipitation_sum"][6]} mm
        </th>
    </tr>
</table>
"""
