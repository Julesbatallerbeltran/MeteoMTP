...
<table id="myTable">
    ...
    <tr title="Quantité de précipitations" style="background-color: rgb(180, 255, 255)">
        <th style="background-color: rgb(255, 255, 255); border-bottom:3px solid rgb(20, 15, 185); border-right:3px solid rgb(20, 15, 185); border-left:3px solid rgb(20, 15, 185)">
            <img src="humidity.svg"> {data["daily"]["precipitation_sum"][0]} mm
        </th>
        <th>
            <img src="humidity.svg"> {data["daily"]["precipitation_sum"][1]} mm
        </th>
        <th>
            <img src="humidity.svg"> {data["daily"]["precipitation_sum"][2]} mm
        </th>
        <th>
            <img src="humidity.svg"> {data["daily"]["precipitation_sum"][3]} mm
        </th>
        <th>
            <img src="humidity.svg"> {data["daily"]["precipitation_sum"][4]} mm
        </th>
    </tr>
</table>
"""
