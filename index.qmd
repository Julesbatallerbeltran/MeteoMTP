...
<table border="1" cellspacing="10">
    <!-- Ligne 1 -->
    <tr title="Date" style="background-color: rgb(135, 206, 250)">
        <th>    
            {nameday[0]}
            <br>Today
            <br>
    ...
    <!-- Ligne 3 -->
    <tr title="Vent moyen et direction moyenne" style="background-color: rgb(192, 192, 192)">
...
#| warning: false
#| 
datetime.utcfromtimestamp(1700131598.8112667)

CT=current_time.replace(microsecond=0)
print(f"Computation was performed at : {CT} (GMT)")
print(datetime.utcfromtimestamp(1700132612.9468145))
```
