...
<table id="myTable">
    ...
    <tr title="Vitesse moyenne du vent" style="background-color: rgb(180, 255, 255)">
        <th style="background-color: rgb(255, 255, 255); border-right:3px solid rgb(20, 15, 185); border-left:3px solid rgb(20, 15, 185)">
            {wind_day[0]} km/h
            <br>{data["daily"]["wind_direction_10m_dominant"][0]} 
        </th>
        <th>
            {wind_day[1]} km/h
            <br>{data["daily"]["wind_direction_10m_dominant"][1]}
        </th>
        <th>
            {wind_day[2]} km/h
            <br>{data["daily"]["wind_direction_10m_dominant"][2]}
        </th>
        <th>
            {wind_day[3]} km/h
            <br> Direction :
                <div style="width: 12px; height: 12px; overflow: hidden; transform: rotate({data["daily"]["wind_direction_10m_dominant"][3]}); display: inline-block; margin: 0 auto;">
                    <div style="width: 12px; height: 12px; border-left: 5px solid transparent; border-right: 5px solid transparent; border-bottom: 15px solid black;">
                    </div>
            </div>
        </th>
        <th>
            {wind_day[4]} km/h
            <br> Direction : 
            <div style="width: 12px; height: 12px; overflow: hidden; transform: rotate({data["daily"]["wind_direction_10m_dominant"][4]}); display: inline-block; margin: 0 auto;">
    ...
    <tr title="Quantité de précipitations" style="background-color: rgb(180, 255, 255)">
        <th style="background-color: rgb(255, 255, 255); border-bottom:3px solid rgb(20, 15, 185); border-right:3px solid rgb(20, 15, 185); border-left:3px solid rgb(20, 15, 185)">
            <img src="images_svg/humidity.svg"> {data["daily"]["precipitation_sum"][0]} mm
        </th>
        <th>
            <img src="images_svg/humidity.svg"> {data["daily"]["precipitation_sum"][1]} mm
        </th>
        <th>
            <img src="images_svg/humidity.svg"> {data["daily"]["precipitation_sum"][2]} mm
        </th>
        <th>
            <img src="images_svg/humidity.svg"> {data["daily"]["precipitation_sum"][3]} mm
        </th>
        <th>
            <img src="images_svg/humidity.svg"> {data["daily"]["precipitation_sum"][4]} mm
        </th>
    </tr>
</table>
"""
